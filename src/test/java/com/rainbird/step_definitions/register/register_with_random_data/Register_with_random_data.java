...
import com.rainbird.utils.test_data.Generate_random_value;
...
public class Register_with_random_data {
    ...
    public void user_fill_out_country(){
        ...
        String country_opt_value = processor.getSelectedOptionText(account_infor.select_country);
        try {
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
            action.selectrandomOption(account_infor.select_country, account_infor.Select_country_by_random_index_value());
    ...
    public void timezone(){
        try {
            ...
            Thread.sleep(1000);
            action.selectrandomOption(account_infor.select_timezone,account_infor.Select_timezone_by_random_index_value());
        } catch (InterruptedException e){}
    }
    ...
    public void user_fill_out_postal_code(){
        try {
            ...
            processor.retrieveInputValue(account_infor.postal_code,"Postal code");
        } catch (InterruptedException e){}
    }
    @And("User fill out State")
        ...
        try {
            Thread.sleep(1000);
            String country_value = processor.getSelectedOptionText(account_infor.select_country);
            Thread.sleep(1000);
            System.out.println("* SELECT STATE field:");
            ...
            if (country_value.equalsIgnoreCase("united states")){
                check.evaluateResult(check.checkAvailability(account_infor.select_state),"STATE field should be CLICKABLE when SELECT COUNTRY is \"United States\"","STATE field should be DISABLED when SELECT COUNTRY is not \"United States\"");
                action.selectrandomOption(account_infor.select_state,account_infor.Select_state_by_random_index_value());
    ...
    public void user_fill_out_username(){
        try {
            ...
            processor.retrieveInputValue(register_login.username,"Username");
        } catch (InterruptedException e){}
    }
    ...
    public void user_fill_out_confirm_password(){
        try {
            Thread.sleep(1000);
            String valid_confirm_password = processor.getInputValue(register_login.password);
